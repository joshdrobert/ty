...
IMG_SIZE = 224
CLASSES = ['Normal', 'Reduced Metabolism', 'Enhanced Sensitivity']
...
def get_test_samples():
    ...
    if not os.path.exists(TEST_DATA_DIR):
        return [
            {'id': f'sample_{i}', 'path': f'test/{CLASSES[i % 3].lower().replace(" ", "_")}/img_{i}.jpg', 'label': CLASSES[i % 3]}
            for i in range(30)
        ]
